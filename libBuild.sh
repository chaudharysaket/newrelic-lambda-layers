...
function fetch_extension {
    arch=$1
    # This is APM+Lambda Fusion Extension for testing
    url="https://github.com/chaudharysaket/newrelic-lambda-extension/releases/download/v2.4.0/newrelic-lambda-extension.${arch}.zip"
