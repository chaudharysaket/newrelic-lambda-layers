...
function fetch_extension {
    arch=$1
    # url="https://github.com/chaudharysaket/newrelic-lambda-extension/releases/download/v5.0.0/newrelic-lambda-extension.arm64.zip"
    url="https://github.com/chaudharysaket/newrelic-lambda-extension/releases/download/v5.0.0/newrelic-lambda-extension.${arch}.zip"
